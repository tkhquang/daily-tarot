defmodule DailyTarotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DailyTarotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DailyTarotWeb.Gettext, "errors", msg, opts)
    end
  end
